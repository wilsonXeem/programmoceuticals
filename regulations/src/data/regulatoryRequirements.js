export const NAFDAC_REQUIREMENTS = {
  ...
  "3.2.S.1": {
    ...
    requirements: [
      "Nomenclature (INN, chemical names, CAS number)",
      "Structural information and molecular formula",
  ...
  "3.2.S.1.3": {
    ...
    requirements: [
      ...
      "pH-solubility profile (pH 1.2–6.8) at 37°C",
      "Dose/solubility volume (BCS classification): Measure solubility at pH 1.2–6.8 at 37°C, identify lowest solubility value, calculate: Highest Strength (mg) ÷ Lowest Solubility (mg/mL). If ≤ 250 mL → Highly soluble (BCS), If > 250 mL → Not highly soluble",
  ...
  "5.3.1.2": {
    ...
    requirements: [
      "Complete bioequivalence study report",
      "Statistical analysis of pharmacokinetic parameters",
      "Bioanalytical method validation",
      "Individual subject data and listings"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "3.2.P.3.5": {
    ...
    requirements: [
      ...
      "Sterilization Requirements: Terminal steam sterilization preferred, F₀ range/temperature range/dwell time, justify alternative methods (EO, radiation, dry heat), filter validation (pore size, extractables, adsorption)",
  ...
  "3.2.P.8": {
    ...
    requirements: [
      "3.2.P.8.1 Stability Summary and Conclusions: Demonstrate quality variation with temperature/humidity/light, WHO TRS 953 compliance, minimum 6 months accelerated (40°C/75% RH) and long-term (30°C/75% RH) data",
  ...
  "3.2.P.8.1": {
    ...
    requirements: [
      ...
      "Climatic Zone Requirements: WHO long-term conditions 30°C ± 2°C / 75% ± 5% RH required, other conditions need strong justification",
      "Container-Type Considerations: Follow WHO guidelines for impermeable/semi-permeable containers, refrigerator/freezer products, below -20°C storage",
      "Minimum Data: Accelerated 40°C ± 2°C / 75% ± 5% RH for 6 months, Long-term 30°C ± 2°C / 75% ± 5% RH for 6 months",
      ...
      "Shelf-Life Estimation (ICH Q1E): If 6-month accelerated shows no significant change/little variability, shelf-life may be up to 2× long-term data period but not more than long-term + 12 months"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "4.1": {
    ...
    description: "A structured Table of Contents must precede all non-clinical study reports.",
    requirements: [
      "Must provide structured Table of Contents preceding all non-clinical study reports"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "4.2": {
    title: "Study Reports",
    description: "Non-clinical study reports organized in strict order: Pharmacology, Pharmacokinetics, and Toxicology.",
    requirements: [
      "Study reports must follow strict order: 4.2.1 Pharmacology, 4.2.2 Pharmacokinetics, 4.2.3 Toxicology"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "4.2.1": {
    title: "Pharmacology",
    description: "Pharmacology studies including primary/secondary pharmacodynamics, safety pharmacology, and drug interactions.",
    requirements: [
  ...
  "4.2.2": {
    ...
    description: "Pharmacokinetic studies including ADME, analytical methods, and drug interactions.",
    requirements: [
      ...
      "4.2.2.4 Metabolism",
      "4.2.2.5 Excretion",
      "4.2.2.6 Non-clinical PK Drug Interactions",
      "4.2.2.7 Additional PK Studies"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "4.2.3": {
    title: "Toxicology",
    description: "Toxicology studies organized by type including single/repeat-dose, genotoxicity, carcinogenicity, reproductive toxicity, and other studies.",
    requirements: [
      "4.2.3.1 Single-Dose Toxicity: Organize by species, by route",
      "4.2.3.2 Repeat-Dose Toxicity: Organize by species, by route, by duration. Include toxicokinetic support data",
      "4.2.3.3 Genotoxicity: 4.2.3.3.1 In vitro studies, 4.2.3.3.2 In vivo studies (with relevant toxicokinetics)",
      "4.2.3.4 Carcinogenicity: Include supportive TK data. 4.2.3.4.1 Long-term studies, 4.2.3.4.2 Short-/medium-term studies, 4.2.3.4.3 Other carcinogenicity-related studies",
      "4.2.3.5 Reproductive & Developmental Toxicity: 4.2.3.5.1 Fertility & early embryonic development, 4.2.3.5.2 Embryo-fetal development, 4.2.3.5.3 Prenatal & postnatal development, 4.2.3.5.4 Juvenile animal studies",
      "4.2.3.6 Local Tolerance",
      "4.2.3.7 Other Toxicity Studies: 4.2.3.7.1 Antigenicity, 4.2.3.7.2 Immunotoxicity, 4.2.3.7.3 Mechanistic studies, 4.2.3.7.4 Dependence, 4.2.3.7.5 Metabolites, 4.2.3.7.6 Impurities, 4.2.3.7.7 Other relevant studies"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "4.3": {
    ...
    description: "Supporting citations for non-clinical pharmacology, PK, and toxicity studies.",
    requirements: [
      "Provide supporting citations for non-clinical pharmacology, PK, and toxicity studies"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "module4": {
    ...
    description: "Not normally required for multisource/generic products. Included to show required format and structure for toxicity/safety justification in new/innovator products.",
    requirements: [
      "Applicability: Not normally required for multisource/generic products",
      "Purpose: Included in CTD only to show required format and structure",
      "Use Case: Used for toxicity/safety justification in new/innovator products",
      "References: Follow ICH M4S (R2) for Module 4 organization, required study design, data content guidelines"
    ],
    format: "PDF",
    mandatory: false,
    apiOptions: ["all"],
  ...
  "1.2": {
    ...
    requirements: [
      "Application letter and registration forms",
      "Legal documents (incorporation, power of attorney)",
      "Manufacturing certificates and authorizations",
      "GMP certificates and inspection invitations"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"]
  ...
  "1.3.1": {
    ...
    requirements: [
      "Follow NAFDAC/WHO SmPC format",
      "Must include: Indications, Dosage and administration, Contraindications, Warnings, ADRs, Pharmacology, Storage instructions"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"]
  ...
  "1.3.2": {
    ...
    requirements: [
      ...
      "Must contain: NAFDAC logo space, Batch number, Mfg + Exp dates, Storage conditions, Manufacturer details, Active ingredients, Route of administration"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"]
  ...
  "1.3.3": {
    ...
    requirements: [
      ...
      "Must include: What the medicine is for, How to use it, Warnings, Side effects, Storage, Manufacturer"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"]
  ...
  "1.5": {
    ...
    requirements: [
      "PDFs, Word files, eCTD-format when applicable",
      "Must be searchable, correctly bookmarked, and virus-free"
    ],
  ...
  "1.6": {
    ...
    requirements: [
      "Samples of market pack",
      "Must match the proposed labeling",
      "Quantity varies depending on product class"
    ],
  ...
  "module2": {
    ...
    description: "Provides high-level summaries of the Quality (CMC), Non-clinical, and Clinical information contained in Modules 3–5. Assists assessors in quickly understanding the product's key characteristics, supporting data, and conclusions. Each section must be concise, cross-referenced, and scientifically justified.",
    requirements: [
      "CTD Table of Contents (Modules 2-5)",
      "CTD Introduction",
      "Quality Overall Summary (QOS-PD)",
      "Non-clinical Overview (if applicable)",
      "Clinical Overview (if applicable)",
      "Written and tabulated summaries (if applicable)"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
    section: "Summaries",
    conditionalText: "Sections 2.4-2.7 usually not required for multisource/generic products"
  },

  "2.1": {
    title: "CTD Table of Contents",
    description: "A complete index of all Module 2 subsections.",
    requirements: [
      "Must reflect the sequence: 2.1 → 2.2 → 2.3 → 2.4 → 2.5 → 2.6 → 2.7",
      "Page numbers must correspond to the submitted document",
      "All sections must be included; where not applicable, state N/A with brief justification"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"]
  ...
  "2.2": {
    title: "Introduction",
    description: "A short overview explaining the pharmaceutical product, indication, formulation platform, and purpose of the submission. Should be brief (typically 1 page).",
    requirements: [
      "Proprietary name and INN",
      "Dosage form and strength",
      "Route of administration",
      "Pharmacological class",
      "Indication(s)",
      "Summary of clinical use (when applicable)",
      "Overview of the submission (new, renewal, variation, new strength, etc.)"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"]
  ...
  "2.3": {
    ...
    description: "Summary of Module 3; WHO format recommended. Single document summarizing all quality-related information from Module 3.",
    requirements: [
      "2.3.S Drug Substance Summary: General information (nomenclature, structure, properties, BCS class), Manufacture (synthetic route, flow diagram, critical controls), Characterization (structure elucidation, impurities, polymorphism), Control (specifications, analytical methods, batch analyses), Reference standards, Container-closure system, Stability (stress/accelerated/long-term data, storage conditions)",
      "2.3.P Drug Product Summary: Description and composition (dosage form, complete composition table, overages), Pharmaceutical development (formulation rationale, compatibility, dissolution, BE/biowaiver), Manufacture (process description, flow diagram, critical steps, validation), Control of excipients and drug product (specifications, methods, batch analyses), Reference standards, Container-closure system, Stability (long-term/accelerated data, shelf-life, storage conditions)",
      "Follow ICH M4Q(R1) structure",
      "Must not introduce new data not found in Module 3"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "2.4": {
    ...
    description: "A written overview discussing pharmacology, pharmacokinetics, and toxicology data (Summary of Module 4).",
    requirements: [
      "Summary of pharmacodynamics",
      "Summary of ADME (Absorption, Distribution, Metabolism, Excretion)",
      "Critical toxicology findings",
      "Risk-benefit profile",
      "Justification if non-clinical studies were not conducted (e.g., generics)"
    ],
    format: "PDF",
    mandatory: false,
    apiOptions: ["all"],
    conditionalText: "For multisource (generic) products, a justification stating that no new non-clinical studies are required is acceptable"
  },

  "2.5": {
    title: "Clinical Overview",
    description: "High-level summary of Module 5. For generics, focus is on BE/biowaiver.",
    requirements: [
      "Clinical pharmacology summary",
      "Efficacy and safety overview",
      "Clinical justification for dose, route, indication",
      "Overview of biopharmaceutics (BE or biowaiver)",
      "Benefit–risk assessment"
    ],
    format: "PDF",
    mandatory: false,
    apiOptions: ["all"],
    conditionalText: "Not usually required for generics"
  },

  "2.6": {
    title: "Non-clinical Written and Tabulated Summaries",
    description: "Detailed summaries of non-clinical findings with tabulated data.",
    requirements: [
      "2.6.1 Pharmacology Summary: Primary and secondary pharmacodynamics, Safety pharmacology",
      "2.6.2 Pharmacokinetics Summary: ADME tables and key data",
      "2.6.3 Toxicology Summary: Single-dose, repeat-dose, genotoxicity, reproductive toxicity, carcinogenicity"
    ],
    format: "PDF",
    mandatory: false,
    apiOptions: ["all"],
    conditionalText: "For generics: 'Not applicable — no new toxicology studies required.' But a brief literature justification must be included"
  },

  "2.7": {
    title: "Clinical Summary",
    description: "Detailed summary of clinical findings with mandatory elements.",
    requirements: [
      "Biopharmaceutics summary (in vitro dissolution + BE if applicable)",
    ...
    mandatory: false,
    apiOptions: ["all"],
    conditionalText: "For generic products, this section usually includes: BE study summary (if BE required), Biowaiver justification (if BCS or additional strength waiver submitted)"
  },

  "module3": {
    title: "Module 3: Quality",
    description: "Comprehensive quality documentation for drug substance and product with four API submission options",
    requirements: [
      "3.1 Table of Contents (Module 3)",
      "3.2.S Drug Substance - Choose from 4 options: Option 1 (API Prequalification), Option 2 (CEP), Option 3 (APIMF), Option 4 (Full Details)",
  ...
  "3.1": {
    ...
    description: "Complete index listing the location of every study report included in Module 3",
    requirements: [
      "List the location of every study report included in Module 3",
      "Follow CTD numbering sequence",
      "Include page numbers for all sections"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "3.2.S": {
    ...
    description: "API information submitted using one of four options: Option 1 (API Prequalification), Option 2 (CEP), Option 3 (APIMF), Option 4 (Full Details)",
    requirements: [
      "Option 1 - API Prequalification: Complete copy in Module 1 + additional sections (3.2.S.1.3, 3.2.S.4.1, 3.2.S.4.4, 3.2.S.7 if needed)",
      "Option 2 - CEP: Complete CEP + annexes in Module 1 + letter of access + written commitment + additional sections not covered by CEP",
      "Option 3 - APIMF: API manufacturer submits APIMF to NAFDAC, applicant includes entire Open Part + completes all required sections",
      "Option 4 - Full Details: Complete API data in 3.2.S (chemistry, manufacturing, quality controls, process validation)"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "5.1": {
    ...
    description: "Complete Table of Contents listing all clinical study reports, appendices, and referenced documents.",
    requirements: [
      "Provide complete Table of Contents listing: All clinical study reports, All appendices, All referenced documents"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "5.2": {
    ...
    description: "Tabular index of all clinical studies with titles, numbers, phase, design, objective, location, and cross-references.",
    requirements: [
      "Provide tabular index of: All clinical studies included, Study titles/numbers/phase/design/objective/location",
      "Cross-references to full reports in Section 5.3"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "5.3": {
    ...
    description: "Detailed clinical study documentation following ICH E3 and M4E(R2) guidelines.",
    requirements: [
      "Follow ICH E3 and M4E(R2) for clinical study report organization and data requirements",
      "For any section without a report, state 'Not applicable' or 'No study conducted'"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "5.3.1": {
    ...
    description: "Primary requirement for generics. Evaluate rate and extent of drug release from FPP and demonstrate bioavailability or bioequivalence.",
    requirements: [
      "Purpose: Evaluate rate and extent of drug release from FPP and demonstrate bioavailability (BA) or bioequivalence (BE)",
      "Placement Rules: Studies evaluating PK and BA placed in 5.3.1, with cross-references in 5.3.1.1 or 5.3.1.2"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "5.3.2": {
    ...
    description: "Studies using plasma protein binding, hepatic metabolism, and other human biomaterials.",
    requirements: [
      "5.3.2.1 Plasma Protein Binding Study Reports",
      "5.3.2.2 Hepatic Metabolism and Drug Interaction Studies",
      "5.3.2.3 Studies Using Other Human Biomaterials (microsomes, hepatocytes, tissue samples)"
    ],
    format: "PDF",
    mandatory: false,
    apiOptions: ["all"],
  ...
  "5.3.3": {
    ...
    description: "Human PK studies in healthy subjects and patients, including intrinsic and extrinsic factor studies.",
    requirements: [
      "5.3.3.1 Healthy Subject PK & Initial Tolerability Studies",
      "5.3.3.2 Patient PK & Initial Tolerability Studies",
      "5.3.3.3 Intrinsic Factor PK Studies: Impact of age, sex, renal impairment, hepatic impairment",
      "5.3.3.4 Extrinsic Factor PK Studies: Influence of diet, smoking, concomitant drugs",
  ...
  "5.3.4": {
    ...
    description: "Human PD and PK/PD studies in healthy subjects and patients.",
    requirements: [
      "5.3.4.1 Healthy Subject PD and PK/PD Studies",
      "5.3.4.2 Patient PD and PK/PD Studies"
    ],
    format: "PDF",
    mandatory: false,
    apiOptions: ["all"],
  ...
  "5.3.5": {
    ...
    description: "Controlled and uncontrolled clinical studies, integrated analyses, and other clinical investigations.",
    requirements: [
      "5.3.5.1 Controlled Clinical Studies for the Claimed Indication",
      "5.3.5.2 Uncontrolled Clinical Studies: Includes open-label or single-arm studies",
      "5.3.5.3 Integrated Analyses / Meta-Analyses: Pooled analyses from multiple studies, bridging analyses",
      "5.3.5.4 Other Clinical Study Reports: Special investigations, real-world evidence, PK/PD modelling"
    ],
    format: "PDF",
    mandatory: false,
    apiOptions: ["all"],
  ...
  "5.3.6": {
    ...
    description: "Summary of cumulative global post-marketing data for already-marketed products.",
    requirements: [
      "Include for already-marketed products: Summary of cumulative global post-marketing data",
      "Safety signals / significant observations",
      "PSUR or PBRER summaries (if applicable)"
    ],
    format: "PDF",
    mandatory: false,
    apiOptions: ["all"],
  ...
  "5.3.7": {
    ...
    requirements: [
      "Submit: CRFs, Individual patient data listings",
      "In the same sequence and study numbering as full clinical study reports"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "5.4": {
    ...
    requirements: [
      "Provide: All published references cited in the Clinical Overview",
      "Key references cited in: Clinical Summary, individual clinical study reports",
      "Only one copy per reference is required",
      "Additional references must be made available on request"
    ],
    format: "PDF",
    mandatory: true,
    apiOptions: ["all"],
  ...
  "module5": {
    ...
    description: "For multisource (generic) products, only Section 5.3.1 (Biopharmaceutical Studies) is typically required. Full module structure included for correct CTD formatting.",
    requirements: [
      "General Notes: For multisource (generic) products, only Section 5.3.1 (Biopharmaceutical Studies) is typically required",
      "Full module structure included for correct CTD formatting and placement",
      "Follow ICH E3 and M4E(R2) for clinical study report organization and data requirements",
      "For any section without a report, state 'Not applicable' or 'No study conducted'"
    ],
    format: "PDF",
  ...
  "3.2.S.7.1": {
    ...
    requirements: [
      ...
      "Accelerated Storage: 40°C ± 2°C / 75% ± 5% RH for minimum 6 months",
      "Long-term Storage: 30°C ± 2°C / 75% ± 5% RH (or 65% ± 5% if justified) for minimum 6 months",
  ...
  "3.2.S.7.3": {
    ...
    requirements: [
      ...
      "Accelerated results (40°C/75% RH, 6 months minimum)",
      "Long-term results (30°C/75% RH or 65% RH, 6 months minimum)",
